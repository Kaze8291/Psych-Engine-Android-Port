...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Ported By Kaze', 0.2], //From 0% to 19%
		['Ported By Kaze', 0.4], //From 20% to 39%
		['Ported By Kaze', 0.5], //From 40% to 49%
		['Ported By Kaze', 0.6], //From 50% to 59%
		['Ported By Kaze', 0.69], //From 60% to 68%
		['Ported By Kaze', 0.7], //69%
		['Ported By Kaze', 0.8], //From 70% to 79%
		['Ported By Kaze', 0.9], //From 80% to 89%
		['Ported By Kaze', 1], //From 90% to 99%
		['Ported By Kaze', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
